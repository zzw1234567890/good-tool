...
const { autoGenerateDataByResult } = require("./lib/analog-data-generator/autoGenerator");
...
const activate = (context) => {
  ...
  subscriptions.push(
    commands.registerCommand("good-tool.autoGenerateDataByResult", autoGenerateDataByResult)
  );
